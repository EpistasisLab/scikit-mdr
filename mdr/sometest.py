...
Gist
 ...
 Watch 82
  Star 1,059
  Fork 127 rhiever/tpot
 Code  Issues 29  Pull requests 5  Wiki  Pulse  Graphs
Branch: master Find file Copy pathtpot/tests.py
b30fbba  14 days ago
@teaearlgraycold teaearlgraycold Add get_params function to TPOT to mimic the sklearn interface
7 contributors @GJena @teaearlgraycold @rhiever @tcfuji @bartleyn @rasbt @screwed99
RawBlameHistory     790 lines (561 sloc)  33.3 KB
"""
    Unit tests for TPOT.
"""
